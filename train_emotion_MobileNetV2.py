...
from models_final import MobileNetV2 
...
# model
train_model = MobileNetV2(class_num=class_num)
...
writer = SummaryWriter(log_dir="./Logs/train_emotion_MobileNetV2")
...
for epoch in tqdm(range(epochs)):
    ...
    model_save_path = f"./models/train_emotion_MobileNetV2/model_epoch_{epoch+1}.pth"
